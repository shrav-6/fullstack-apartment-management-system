  ...
  if(user1==null) {
    if(role=="Tenant") {
      ...
      res.json({"success": true, "message": "user profile created successfully"});
        ...
        res.json({"success": false, "error": "Not successfull,invalid buildingname"});
      }
    }
      ...
      res.json({"success": false, "error": "Not successful,no specific roles"});
    } 
  }
  else {
    res.json({"success": false, "error": "Email already used for user!"});
  }     
});
