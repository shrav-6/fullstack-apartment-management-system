...
import { getAllNotices, postAllNotices, editAllNotices, deleteNotice } from './Notices.service';
import { setNotices, setTitle, setDescription, setPostType, resetPostData } from '../data/notice.actions';
